...
// // Para upload file como fotos y videos a firebase storage
...
//         try {
//             debugger
//             const products = await firebase.storage.ref('products')
//             debugger
//             const filenamePath = await products.child(filename)
//             debugger
//             const url = await filenamePath.getDownloadURL()
...
//                                 id="image"
//                                 name="image"
//                                 randomizeFilename // en caso de archivos repetidos crea nombre aleatorio
//                                 storageRef={firebase.storage.ref('products')} //required
//                                 // funciones que se activan cuando la imagen esta cargando
